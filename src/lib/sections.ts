...
export const sections: Section[] = [
  ...
  // ── 00 Silora Orient ───────────────────────────────────────────────
  {
    ...
    deadlines: [
      { date: '2026-05-25', label: 'Pop-up event 报名截止', urgent: true },
      { date: '2026-05-31', label: 'Mailchimp 欢迎邮件序列激活' },
      { date: '2026-06-10', label: 'Cal.com 日历链接上线 + Stripe 付款链接' },
    ],
    impact: 0.85,
    visa: 0.3,
    cost: 0.8,
    tasks: [
      '🆕 Pop-up event 报名管理 + 参与者跟进',
    ...
    completedTasks: [
      '✦ Be My Model 私密邀请页上线',
      '定价体系重构 ($99/$248/$358/$568/$848/$1400+)',
      '$6 推广码系统上线 (SL6-XXXXXX)',
      'Vercel 部署流水线修复',
      'GA4 追踪脚本全站添加',
      'Mailchimp 订阅 API 集成',
    ],
  ...
  // ── 01 Research ────────────────────────────────────────────────────
  {
    ...
    deadlines: [
      { date: '2026-05-25', label: 'MIT 暑研 PI 联系邮件发出', urgent: true },
  ...
  // ── 02 Met Tour Business System ────────────────────────────────────
  {
    ...
    deadlines: [
      { date: '2026-05-30', label: '公开评语 Marketing 展示页上线' },
